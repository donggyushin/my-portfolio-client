...
class MyStory extends React.Component {
    render() {
        return <Container>
            <SmallText>내 이야기를 조금 더 해볼께. 나는 1994년에 전주에서 태어났어. 그리고 2013년에는 지금 내가 다니고 있는 한국성서대학교에 입학했어.
                내 개발자 인생의 시작점이라고도 볼 수 있지. 하지만 내가 코딩에 관심을 가지기 시작한 건 조금 더 먼 훗날의 이야기야. 처음에는 코딩이라는 것에 전혀
                1도 관심이 없었어. 그래서 그 당시에는 나의 누나와 함께 인터넷 쇼핑몰을 운영하기 시작했었어. 2013년부터 2017년까지.
                 </SmallText>
            <div style={{
                height: 100
            }} />
